...
def FaceSwap(image, image2):
    ...
    for triangle_index in indexes_triangles:
        ...
        #draw triangle
        # cv.line(image, tr1_pt1, tr1_pt2, (0,0,255), 2)
        # cv.line(image, tr1_pt2, tr1_pt3, (0,0,255), 2)
        # cv.line(image, tr1_pt3, tr1_pt1, (0,0,255), 2)
        ...
        #draw triangle
        # cv.line(image2, tr2_pt1, tr2_pt2, (0,0,255), 2)
        # cv.line(image2, tr2_pt2, tr2_pt3, (0,0,255), 2)
        # cv.line(image2, tr2_pt3, tr2_pt1, (0,0,255), 2)
    ...
    cv.imwrite('./face_swap_image.jpg', final_result) 
...
if __name__ == '__main__':
    #take two image
    #source image
    img1 = cv.imread('./Photos/long.jpg')
    #destination image
    img2 = cv.imread('./Photos/man_2.jpg')
